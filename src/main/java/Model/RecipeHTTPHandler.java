 ...
 private String handleGet(HttpExchange httpExchange) throws IOException {
  ...
  private String handlePost(HttpExchange httpExchange) throws IOException {
    ...
    if(postData.substring(0,postData.indexOf("=")) == "mealType"){
      ...
      GPTModel req = new MockGPT();
      try {
        String recipeText;
        if(postData.substring(0, 1) == "D"){recipeText = req.getResponse("Dinner", ingredients);}
        else if(postData.substring(0, 1) == "L"){recipeText = req.getResponse("Lunch", ingredients);}
        else if(postData.substring(0, 1) == "B"){recipeText = req.getResponse("Breakfast", ingredients);}
...
class MockRecipeHTTPHandler implements RecipeHTTPHandlerInterface{
